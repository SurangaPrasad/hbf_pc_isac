...
if run_program == 1:
    ...
    if run_UPGA_J5_decay == 1:
        ...
        sum_rate_UPGA_J5_decay, crb_UPGA_J5_decay, F_UPGA_J5_decay, W_UPGA_J5_decay, gradient_norm_history_UPGA_J5_decay = model_UPGA_J5_decay.execute_PGA(H_test, xi_0, A_dot, R_N_inv,
                                                                                             snr,
                                                                                             n_iter_outer,
                                                                                            n_iter_inner_J5)
    ...
    if run_UPGA_J10_decay == 1:
        ...
        sum_rate_UPGA_J10_decay, crb_UPGA_J10_decay, F_UPGA_J10_decay, W_UPGA_J10_decay, gradient_norm_history_UPGA_J10_decay = model_UPGA_J10_decay.execute_PGA(H_test, xi_0, A_dot, R_N_inv,
                                                                                             snr,
                                                                                             n_iter_outer,
                                                                                            n_iter_inner_J10)
    ...
    if run_UPGA_J20_decay == 1:
        ...
        sum_rate_UPGA_J20_decay, crb_UPGA_J20_decay, F_UPGA_J20_decay, W_UPGA_J20_decay, gradient_norm_history_UPGA_J20_decay = model_UPGA_J20_decay.execute_PGA(H_test, xi_0, A_dot, R_N_inv,
                                                                                             snr,
                                                                                             n_iter_outer,
                                                                                            n_iter_inner_J20)
