...
if plot_figure == 1:
    ...
    if run_UPGA_J20_decay == 1:
        plt.plot(iter_outer_x_J20_decay, rate_iter_UPGA_J20_decay[outer_idx_J20_decay], ':d', markevery=5, color='purple', linewidth=3, markersize=7, label='PGA (J=20, decay)')
    if run_UPGA_J_GradReuse == 1:
    ...
    plt.grid()
    safe_legend(loc='best', fontsize="14", labelspacing=0.15)
    ...
    if run_UPGA_J20_decay == 1:
        plt.plot(iter_outer_x_J20_decay, crb_iter_UPGA_J20_decay[outer_idx_J20_decay], ':d', markevery=5, color='purple', linewidth=3, markersize=7, label='PGA (J=20, decay)')
    if run_UPGA_J_GradReuse == 1:
    ...
    if run_conv_PGA_J10 == 1:
        ...
        plt.plot(iter_outer_x, obj_iter_conv_PGA_J10, ':*', markevery=5, color='red', linewidth=3, markersize=7, label='PGA (J=10)')
    if run_conv_PGA_J20 == 1:
    ...
    if run_UPGA_J5 == 1:
        ...
        plt.plot(iter_outer_x, obj_iter_UPGA_J5, ':*', markevery=5, color='blue', linewidth=3, markersize=7, label=label_UPGA_J5)
    if run_UPGA_J10 == 1:
        obj_iter_UPGA_J10 = OMEGA * rate_iter_UPGA_J10[outer_idx_J10] + crb_iter_UPGA_J10[outer_idx_J10]
        plt.plot(iter_outer_x, obj_iter_UPGA_J10, ':*', markevery=5, color='black', linewidth=3, markersize=7, label=label_UPGA_J10)
    if run_UPGA_J20 == 1:
    ...
    if run_UPGA_J5_decay == 1:
        ...
        plt.plot(iter_outer_x_J5_decay, obj_iter_UPGA_J5_decay, ':d', markevery=5, color='purple', linewidth=3, markersize=7, label='PGA (J=5, decay)')
    if run_UPGA_J10_decay == 1:
    ...
    if run_UPGA_J20_decay == 1:
        ...
        plt.plot(iter_outer_x_J20_decay, obj_iter_UPGA_J20_decay, ':d', markevery=5, color='purple', linewidth=3, markersize=7, label='PGA (J=20, decay)')
    if run_UPGA_J_GradReuse == 1:
