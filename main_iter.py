...
if run_program == 1:
    ...
    if run_UPGA_J1 == 1:
        ...
        sum_rate_UPGA_J1, crb_UPGA_J1, power_UPGA_J1, F_UPGA_J1, W_UPGA_J1 = model_UPGA_J1.execute_PGA(H_test, xi_0, A_dot, R_N_inv,
                                                                                             snr,
                                                                                             n_iter_outer,
                                                                                             n_iter_inner_J1)
...
if plot_figure == 1:
    ...
    if run_conv_PGA_J5 == 1:
        plt.plot(iter_outer_x, rate_iter_conv_PGA_J5[outer_idx_J5], '--', markevery=5, color='blue', linewidth=3, markersize=7, label='PGA (J=5)')
    if run_conv_PGA_J10 == 1:
        plt.plot(iter_outer_x, rate_iter_conv_PGA_J10[outer_idx_J10], '-*', markevery=5, color='blue', linewidth=3, markersize=7, label='PGA (J=10)')
    if run_UPGA_J1 == 1:
    ...
    if run_UPGA_J5_decay == 1:
        plt.plot(iter_outer_x_J5_decay, rate_iter_UPGA_J5_decay[outer_idx_J5_decay], '--', markevery=5, color='purple', linewidth=3, markersize=7, label=label_UPGA_J5_decay)
    if run_UPGA_J10_decay == 1:
        plt.plot(iter_outer_x_J10_decay, rate_iter_UPGA_J10_decay[outer_idx_J10_decay], '-*', markevery=5, color='purple', linewidth=3, markersize=7, label=label_UPGA_J10_decay)
    if run_UPGA_J20_decay == 1:
    ...
    if run_conv_PGA_J5 == 1:
        ...
        plt.plot(iter_outer_x, obj_iter_conv_PGA_J5[outer_idx_J5], '--', markevery=5, color='blue', linewidth=3, markersize=7, label='PGA (J=5)')
    if run_conv_PGA_J10 == 1:
        obj_iter_conv_PGA_J10 = rate_iter_conv_PGA_J10 + OMEGA * crb_iter_conv_PGA_J10
        plt.plot(iter_outer_x, obj_iter_conv_PGA_J10[outer_idx_J10], '-*', markevery=5, color='blue', linewidth=3, markersize=7, label='PGA (J=10)')
    if run_conv_PGA_J20 == 1:
        obj_iter_conv_PGA_J20 = rate_iter_conv_PGA_J20 + OMEGA * crb_iter_conv_PGA_J20[outer_idx_J20]
        plt.plot(iter_outer_x, obj_iter_conv_PGA_J20[outer_idx_J20], '-', markevery=5, color='blue', linewidth=3, markersize=7, label='PGA (J=20)')
    if run_UPGA_J5 == 1:
    ...
    if run_UPGA_J10 == 1:
        obj_iter_UPGA_J10 = rate_iter_UPGA_J10[outer_idx_J10] + OMEGA * crb_iter_UPGA_J10[outer_idx_J10]
        plt.plot(iter_outer_x, obj_iter_UPGA_J10, '-*', markevery=5, color='red', linewidth=3, markersize=7, label=label_UPGA_J10)
    if run_UPGA_J20 == 1:
        obj_iter_UPGA_J20 = rate_iter_UPGA_J20[outer_idx_J20] + OMEGA * crb_iter_UPGA_J20[outer_idx_J20]
        plt.plot(iter_outer_x, obj_iter_UPGA_J20, '-', markevery=5, color='red', linewidth=3, markersize=7, label=label_UPGA_J20)
    if run_UPGA_J10_RMSProp == 1:
        obj_iter_UPGA_J10_RMSProp = rate_iter_UPGA_J10_RMSProp[outer_idx_J10] + OMEGA * crb_iter_UPGA_J10_RMSProp[outer_idx_J10]
        plt.plot(iter_outer_x, obj_iter_UPGA_J10_RMSProp, ':', markevery=5, color='green', linewidth=3, markersize=7, label='UPGA (J=10, RMSProp)')
    if run_UPGA_J10_PRCDN == 1:
        obj_iter_UPGA_J10_PRCDN = rate_iter_UPGA_J10_PRCDN[outer_idx_J10] + OMEGA * crb_iter_UPGA_J10_PRCDN[outer_idx_J10]
        plt.plot(iter_outer_x, obj_iter_UPGA_J10_PRCDN, ':*', markevery=5, color='green', linewidth=3, markersize=7, label='UPGA (J=10, PRCDN)')
    if run_UPGA_J5_decay == 1:
        obj_iter_UPGA_J5_decay = rate_iter_UPGA_J5_decay[outer_idx_J5_decay] + OMEGA * crb_iter_UPGA_J5_decay[outer_idx_J5_decay]
        plt.plot(iter_outer_x_J5_decay, obj_iter_UPGA_J5_decay, '--', markevery=5, color='purple', linewidth=3, markersize=7, label=label_UPGA_J5_decay)
    if run_UPGA_J10_decay == 1:
        obj_iter_UPGA_J10_decay = rate_iter_UPGA_J10_decay[outer_idx_J10_decay] + OMEGA * crb_iter_UPGA_J10_decay[outer_idx_J10_decay]
        plt.plot(iter_outer_x_J10_decay, obj_iter_UPGA_J10_decay, '-*', markevery=5, color='purple', linewidth=3, markersize=7, label=label_UPGA_J10_decay)
    if run_UPGA_J20_decay == 1:
        obj_iter_UPGA_J20_decay = rate_iter_UPGA_J20_decay[outer_idx_J20_decay] + OMEGA * crb_iter_UPGA_J20_decay[outer_idx_J20_decay]
        plt.plot(iter_outer_x_J20_decay, obj_iter_UPGA_J20_decay, '-', markevery=5, color='purple', linewidth=3, markersize=7, label=label_UPGA_J20_decay)
    if run_UPGA_J_GradReuse == 1:
