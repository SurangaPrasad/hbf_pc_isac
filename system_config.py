...
model_file_name_UPGA_partial_J5 = directory_model + 'UPGA_partial_J5_partial.pth'
model_file_name_UPGA_partial_J10 = directory_model + 'UPGA_partial_J10_partial.pth'
