...
label_UPGA_J1 = 'F-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=120$'
label_UPGA_J4 = 'F-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=480$'
label_UPGA_J5 = 'F-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=600$'
label_UPGA_J6 = 'F-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=720$'
label_UPGA_J10 = 'F-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=1200$'
label_UPGA_J20 = 'F-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=2400$'

label_UPGA_J10_PC = r'UPGA ' + '$(J = ' + str(n_iter_inner_J10) + ', PC)$'
label_conv_PGA_J10_PC = 'Conventional PGA ' + '$(J = ' + str(n_iter_inner_J10) + ', PC)$'

label_UPGA_J5_decay = 'D-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=421$'
label_UPGA_J10_decay = 'D-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=722$'
label_UPGA_J20_decay = 'D-UPGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=20$'
...
Conv_PGA_J1 = 'Conv. PGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=120$'
Conv_PGA_J5 = 'Conv. PGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=600$'
Conv_PGA_J10 = 'Conv. PGA, $\sum_\nolimits{i=0}^{I-1}\widehat{J}_{(i)}=1200$'
