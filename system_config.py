...
label_UPGA_J1 = r'Fixed-UPGA, $\sum\;\widehat{J}_{(i)}=120$'
label_UPGA_J4 = r'Fixed-UPGA, $\sum\;\widehat{J}_{(i)}=480$'
label_UPGA_J5 = r'Fixed-UPGA, $\sum\;\widehat{J}_{(i)}=600$'
label_UPGA_J6 = r'Fixed-UPGA, $\sum\;\widehat{J}_{(i)}=720$'
label_UPGA_J10 = r'Fixed-UPGA, $\sum\;\widehat{J}_{(i)}=1200$'
label_UPGA_J20 = r'Fixed-UPGA, $\sum\;\widehat{J}_{(i)}=2400$'

label_UPGA_J10_PC = r'UPGA ' + '$(J = ' + str(n_iter_inner_J10) + ', PC)$'
label_conv_PGA_J10_PC = 'Conventional PGA ' + '$(J = ' + str(n_iter_inner_J10) + ', PC)$'

label_UPGA_J5_decay = r'Dynamic-UPGA, $\sum\;\widehat{J}_{(i)}=421$'
label_UPGA_J10_decay = r'Dynamic-UPGA, $\sum\;\widehat{J}_{(i)}=722$'
label_UPGA_J20_decay = r'Dynamic-UPGA, $\sum\;\widehat{J}_{(i)}=20$'
...
Conv_PGA_J1 = r'Conv. PGA, $\sum\;\widehat{J}_{(i)}=120$'
Conv_PGA_J5 = r'Conv. PGA, $\sum\;\widehat{J}_{(i)}=600$'
Conv_PGA_J10 = r'Conv. PGA, $\sum\;\widehat{J}_{(i)}=1200$'
