...
label_UPGA_J1 = r'Fixed-UPGA, $J=1$, $\widehat{J}_{\mathrm{tot}}=120$'
label_UPGA_J4 = r'Fixed-UPGA, $J=4$, $\widehat{J}_{\mathrm{tot}}=480$'
label_UPGA_J5 = r'Fixed-UPGA, $J=5$, $\widehat{J}_{\mathrm{tot}}=600$'
label_UPGA_J6 = r'Fixed-UPGA, $J=6$, $\widehat{J}_{\mathrm{tot}}=720$'
label_UPGA_J10 = r'Fixed-UPGA, $J=10$, $\widehat{J}_{\mathrm{tot}}=1200$'
label_UPGA_J20 = r'Fixed-UPGA, $J=20$, $\widehat{J}_{\mathrm{tot}}=2400$'

label_UPGA_J10_PC = r'UPGA ' + '$(J = ' + str(n_iter_inner_J10) + ', PC)$'
label_conv_PGA_J10_PC = 'Conventional PGA ' + '$(J = ' + str(n_iter_inner_J10) + ', PC)$'

label_UPGA_J5_decay = r'Dynamic-UPGA, $J_{\max}=5$, $\widehat{J}_{\mathrm{tot}}=421$'
label_UPGA_J10_decay = r'Dynamic-UPGA, $J_{\max}=10$, $\widehat{J}_{\mathrm{tot}}=722$'
label_UPGA_J20_decay = r'Dynamic-UPGA, $J_{\max}=20$, $\widehat{J}_{\mathrm{tot}}=20$'
...
Conv_PGA_J1 = r'Conv. PGA, $J=1$, $\widehat{J}_{\mathrm{tot}}=120$'
Conv_PGA_J5 = r'Conv. PGA, $J=5$, $\widehat{J}_{\mathrm{tot}}=600$'
Conv_PGA_J10 = r'Conv. PGA, $J=10$, $\widehat{J}_{\mathrm{tot}}=1200$'
