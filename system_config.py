...
label_UPGA_J5_decay = r'Dynamic-UPGA, $J=5$, $\widehat{J}_{\mathrm{tot}}=421$'
label_UPGA_J10_decay = r'Dynamic-UPGA, $J=10$, $\widehat{J}_{\mathrm{tot}}=722$'
label_UPGA_J20_decay = r'Dynamic-UPGA, $J=20$, $\widehat{J}_{\mathrm{tot}}=20$'
